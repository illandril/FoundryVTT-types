  ...
  namespace dnd5e {
    namespace documents {
      namespace ItemSystemData {
        ...
        type Consumable = ItemDescription &
          PhysicalItem &
          ActivatedEffect &
          Action & {
        ...
        type Equipment = ItemDescription &
          PhysicalItem &
          ActivatedEffect &
          Action &
          Mountable & {
